...
- Протестировать ответы с ошибками (400, 502);
...
Выполнить тестирование на нормализацию путей: "/static/../home/index" -> "/home/index".  
Довольно часто CDN кешируют пути/файлы с такими расширениями: .css, .js, .png.  
